...
//                       ((t.zoom = o(h) / this.pinchStartLen), this.pinch.dispatch(t, this.element)),
//                     (t.angle = l(h, e)),
...
//                           e.isDoubleTap &&
//                             (e.doubleTap.dispatch(t, e.element), (e.isDoubleTap = !1))
//                       }, 0)),
//                       e.isDoubleTap ||
...
//         if (
//           (e(this, t), (this.img = i), (this.slide = n), (this.onclose = o), this.img.setZoomEvents)
//         )
//           return !1
//         ;(this.active = !1),
//           (this.zoomedIn = !1),
...
//         for (var s in t) if (x.has(t, s) && !1 === e.call(t[s], t[s], s, t)) break
//   }
//   function S(t) {
...
//     for (; t !== document.body; ) {
//       if (
//         'function' == typeof (t = t.parentElement).matches ? t.matches(e) : t.msMatchesSelector(e)
//       )
//         return t
//     }
//   }
...
//         }
//         if (
//           l.match(/(youtube\.com|youtube-nocookie\.com)\/watch\?v=([a-zA-Z0-9\-_]+)/) ||
//           l.match(/youtu\.be\/([a-zA-Z0-9\-_]+)/) ||
//           l.match(/(youtube\.com|youtube-nocookie\.com)\/embed\/([a-zA-Z0-9\-_]+)/)
//         ) {
//           var r = (function (t) {
//             var e = ''
//             e =
//               void 0 !==
//               (t = t.replace(/(>|<)/gi, '').split(/(vi\/|v=|\/v\/|youtu\.be\/|\/embed\/)/))[2]
...
//                 '' !== v && (u += '<source src="'.concat(v, '" type="video/').concat(p, '">'))
//             }
//           c = L((u += '</video>'))
//         }
//         var f =
...
//                 y = z - p
//               if (
//                 (Math.abs(m) > Math.abs(y) ? ((T = !1), (C = !0)) : ((C = !1), (T = !0)),
//                 (e = M.pageX - L.pageX),
//                 (w = (100 * e) / o),
//                 (i = M.pageY - L.pageY),
//                 (S = (100 * i) / l),
...
//               if (!(e > 29 && u))
//                 return e < 29 && i < 25 ? (k(D, 'greset'), (D.style.opacity = 1), V(c)) : void 0
//               t.close()
//             }
//           },
...
//               )
//             e > 4.5 && (e = 4.5),
//               (u.style.transform = 'scale3d('.concat(e, ', ').concat(e, ', 1)')),
//               (p = e)
//           },
...
//                 this.slideDescription && A(this.slideDescription.parentNode, 'gslide-media')),
...
//               0 !== e || l
//                 ? e !== this.elements.length - 1 || l || k(this.nextButton, 'disabled')
...
//             if (
//               ((this.elements = []),
//               !x.isNil(this.settings.elements) && x.isArray(this.settings.elements))
//             )
...
//             }
//             return (
//               0 == e && (e = document.querySelectorAll('.'.concat(this.settings.selector))),
...
//             ;(s = L(
//               (s = (s = (s = s.replace(/{nextSVG}/g, e)).replace(/{prevSVG}/g, i)).replace(
//                 /{closeSVG}/g,
//                 n,
//               )),
//             )),
...
//                     u.setAttribute('style', 'max-height: calc(100vh - '.concat(h, 'px)')),
...
//                     i.parentNode.setAttribute('style', 'max-width: '.concat(y.width, 'px')),
//                       r && s.setAttribute('style', 'max-width: '.concat(y.width, 'px;'))
//                   } else
//                     (i.parentNode.style.maxWidth = ''.concat(g, 'px')),
//                       r && s.setAttribute('style', 'max-width: '.concat(g, 'px;'))
//                 }
//               }
//             }
//           },
