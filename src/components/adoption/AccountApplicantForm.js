...
const AccountApplicantForm = ({
  ...
  const inputs = [
    ...
    },
    {
      ...
      options: [
        { label: 'Chưa kết hôn (Thay đổi tình trạng hôn nhân)', value: MaritalStatus.single.code },
        {
          label: 'Sống chung chưa kết hôn (Thay đổi tình trạng hôn nhân)',
          value: MaritalStatus.engaged.code,
        },
        {
          label: 'Đã có vợ/chồng (Thay đổi tình trạng hôn nhân)',
          value: MaritalStatus.married.code,
        },
        { label: 'Góa (Thay đổi tình trạng hôn nhân)', value: MaritalStatus.widow.code },
        {
          label: 'Ly hôn hoặc ly thân (Thay đổi tình trạng hôn nhân)',
          value: MaritalStatus.divorce.code,
        },
      ],
    },
    {
...
export default AccountApplicantForm
